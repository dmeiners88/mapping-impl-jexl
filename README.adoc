...
--
[.left]
image::https://travis-ci.com/dmeiners88/mapping-impl-jexl.svg?branch=develop["Build Status", link="https://travis-ci.com/dmeiners88/mapping-api"]
...
This is the Apache Commons JEXL Implementation module for the Zero-Dependency Mapping Libarary.
